            ...
            [1, 2, 3, 4, 5, 6].map((pos) => (
              <section key={pos}>
                ...
                <div className="space-y-1.5">
                      ...
                      >
                        ...
                        <span className="shrink-0 text-right text-[11px] leading-tight">
                          <span className="block">
                            média <b className="text-foreground">{fmt(p.media, 1)}</b>
                          </span>
                  ...
                  {!(data.byPos[String(pos)] ?? []).length && (
                    <p className="text-xs text-muted-foreground">Sem opções com amostra suficiente.</p>
                  )}
                </div>
              </section>
            ))}
